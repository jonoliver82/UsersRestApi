...
* Value Objects with Entities
* Use of Specification and Query objects to encapsulate predicate and selection expressions when performing a query to a Repository
